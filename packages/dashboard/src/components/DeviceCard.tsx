...
import { deviceIcon, deviceIconColor, deviceIconBg, formatValue } from "@/lib/device-utils";
    ...
    <div className="glass-card rounded-2xl p-5 transition-all duration-300 group">
      <div className="mb-4 flex items-start justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-slate-100 leading-tight">{device.name}</h3>
